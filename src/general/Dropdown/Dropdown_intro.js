...
function Dropdown(){
    ...
    return (
        ...
        <ButtonDropdown  isOpen={dropdownOpen} onMouseEnter={onMouseEnter} isClose={dropdownOpen} onMouseLeave={onMouseLeave}> 
          <DropdownToggle style={{backgroundColor:  'white', border:0, color:"black", fontSize:"25px"}} >Introduction</DropdownToggle>

    
        <DropdownMenu> 
        
            <DropdownItem>
            <Link className="menu home" to ={"/"}>Introduction</Link></DropdownItem> 
